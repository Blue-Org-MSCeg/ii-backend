...
router.route('/order/:id').get(orderController.getOrderDetails).put(orderController.addOrder).patch(orderController.editOrder).delete(orderController.deleteOrder);
